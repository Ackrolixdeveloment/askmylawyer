...
/**
 * Nested under the In Progress list so the sidebar keeps that entry
 * highlighted while a ticket is open.
 */
export default async function InProgressTicketDetailPage({
  params,
}: PageProps<"/support/in-progress/[id]">) {
    ...
    <>
      ...
      <main className="min-w-0 px-4 pt-6 pb-8 sm:px-6 lg:px-8 lg:pb-10">
        <BackButton
          ...
          fallbackHref="/support/in-progress"
        />
