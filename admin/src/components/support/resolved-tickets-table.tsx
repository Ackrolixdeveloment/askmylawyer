...
const columns: Column<Ticket>[] = [
  {
    ...
    cell: (row) => (
      <TableLink href={`/support/resolved/${row.id}`}>{row.ticketId}</TableLink>
    ),
  },
  {
    key: "createdBy",
...
interface ResolvedTicketsTableProps {
  tickets: Ticket[];
...
export function ResolvedTicketsTable({
  tickets,
  priorityOptions,
  createdByOptions,
  categoryOptions,
}: ResolvedTicketsTableProps) {
