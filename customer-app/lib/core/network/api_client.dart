...
class ApiClient {
  ...
  static const _refreshPath = '/api/v1/customer/auth/refresh';

  /// Uploads carry case documents, so they get longer than plain JSON calls.
  ...
  /// Called when the session has gone for good — the account was suspended,
  /// or the refresh token no longer works. Set once at startup.
